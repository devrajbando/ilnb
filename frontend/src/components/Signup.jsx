  ...
  <div className="min-h-screen flex items-start justify-center  py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div className="max-w-md w-full space-y-8 bg-gray-900 p-8 rounded-lg shadow-md">
      ...
      <form className="mt-8 space-y-6" onSubmit={()=>setPage(2)}>
        ...
        <button
          type="submit"
          className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
          >
          Submit
        </button>
        <div>
         ...
         <h1 className="text-3xl text-white font-bold text-center mb-6">Investment Risk Assessment</h1>
             ...
             <div className="space-y-10">
               {questions.map((question) => (
                 <div key={question.id} className="mb-8">
                   <h3 className="text-xl font-semibold  text-white mb-4">{question.id}. {question.text}</h3>
